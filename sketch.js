...
function setup() {
  ...
  jungle.scale=0.3
  jungle.x = width /2;
  Kangaroo = createSprite(width / 2 - 50, height - 100);
  kangaroo.setAnimation(kangaroo_running)
  kangaroo.setAnimation(kangaroo_collided)
  kangaroo.setCollider("circle",300)
...
*/
invisibleGround = createSprite(400,100)
...
camera.position.x =    Shrubs[index - 1].position.x;
